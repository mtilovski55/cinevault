...
A modern movie catalog web app built with React + Vite.
...
🚀 Features
	...
	•	🎭 Filter by genre
	•	↕️ Sort by title, year, and rating
	•	⭐ Add movies to watchlist
	•	✅ Mark movies as watched
	•	➕ Create new movies
	•	💬 Clean UI with validation and feedback states
